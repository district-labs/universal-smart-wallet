...
/// @custom:storage-location erc7201:universal.storage.MultiOwnable
...
contract MultiOwnable {
    ...
    ///      Computed from
    /// @dev keccak256(abi.encode(uint256(keccak256("universal.storage.MultiOwnable")) - 1)) & ~bytes32(uint256(0xff))
    ///      Follows ERC-7201 (see https://eips.ethereum.org/EIPS/eip-7201).
    bytes32 private constant UNIVERSAL_MULTI_OWNABLE_STORAGE_LOCATION =
        0x25c89432e39a716a64aedf0925f2b9c8c5a9e6ae299afe144ef9e60a35367f00;
    ...
    function addOwnerBytes(bytes calldata owner) external virtual onlyOwner {
    ...
    function _getMultiOwnableStorage() internal pure returns (MultiOwnableStorage storage $) {
        assembly ("memory-safe") {
            $.slot := UNIVERSAL_MULTI_OWNABLE_STORAGE_LOCATION
        }
    }
}
